...
import { uploadsRootDir } from "@/lib/driver-application-assets.server";
...
export async function GET(
  ...
  const requestedPath = path.resolve(uploadsRootDir, ...segments);
  const baseDir = path.resolve(uploadsRootDir);
